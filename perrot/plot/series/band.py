...
class Band(Series):
    ...
    def get_limits(self, x_range=None, y_range=None, exact=False):
        ...
        if x_range:
            ...
            limits_by_y1 = utils.calc_profile_limits(
                data = (self._x_data, self._y1_data),
                crop = x_range,
                extend = False,
                interpolate = True)
            
            limits_by_y2 = utils.calc_profile_limits(
                data = (self._x_data, self._y2_data),
                crop = x_range,
                extend = False,
                interpolate = True)
            
            limits = utils.combine_limits(limits_by_y1, limits_by_y2)
    ...
    def extract_data(self):
        ...
        # get data size
        size = utils.extract_data_size(self, 'data', 'x', 'y1', 'y2')
