...
class SecondsAxis(Axis):
    """Predefined axis with linear scale and seconds formatter."""
    
    
    def __init__(self, **overrides):
        """Initializes a new instance of the SecondsAxis."""
        ...
        if 'ticker' not in overrides:
            overrides['ticker'] = LinTicker(formatter=SecondsFormatter(hide_suffix=True))
