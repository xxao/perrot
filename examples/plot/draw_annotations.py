...
# add series
sin_series = perrot.plot.Scatter(x=x_data, y=sin_data, title="sin(x)", marker='o')
cos_series = perrot.plot.Profile(x=x_data, y=cos_data, title="cos(x)", marker='s')
tan_series = perrot.plot.Scatter(x=x_data, y=tan_data, title="tan(x)", marker='t')
