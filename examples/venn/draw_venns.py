...
class DrawTest(pero.Graphics):
    ...
    def draw_venn(self, canvas, venn, region, solo):
        ...
        # calc venn
        coords, radii = perrot.venn.calc_venn(*values, mode=mode)
        
        # scale to canvas view
        padding = 20
        w, h = canvas.viewport.wh
        coords, radii = perrot.venn.fit_into(coords, radii, padding, padding + 5, w - 2 * padding, h - 2 * padding - 5)
        ...
        # make regions
        regions = perrot.venn.make_regions(coords, radii)
